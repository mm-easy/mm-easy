...
const PrivacyPolicy = () => {
  ...
  return (
    <p className="text-sm">
      ...
      <br />
      <br />
      {m('PERSONAL_INFORM_PURPOSE')}
      <br />
      <br />
      <span className="font-bold">{m('ARTICLE_3')}</span>
      <br />
      <br />
      {m('COLLECTED_INFORM_PROVIDE')}
      <br />
      {m('WILL_NOT_PROVIDE')}
      <br />
      <br />
      ...
      <br />
      <br />
      {m('INFORM_PROTECT_OFFICER')}
      <br />
      {m('IF_HAVE_INQUIRIES')}
      <br />
      <br />
      <span className="font-bold">{m('CONTACT_US')}</span>
      <br />
      <br />
