...
const MyLevelAndScore = () => {
  return (
    <main className="w-full h-full flex flex-col items-center bg-bgColor2 border-solid border-t border-pointColor1">
      ...
      <div className="flex gap-7 mt-14 font-semibold">
        <div className="flex flex-col items-center w-32">
          <p>레벨</p>
          <p className="mt-5 text-4xl text-pointColor1">999</p>
        </div>
        <VerticalBlueLine />
        <div className="flex flex-col items-center w-32">
          <p>퀴즈 점수</p>
      ...
      <div className="text-center mt-14 text-pointColor1 underline underline-offset-4">
