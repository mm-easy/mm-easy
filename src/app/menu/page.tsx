    ...
    <div className="flex justify-center bg-bgColor1 z-50 fixed inset-0 items-center mt-16 h-screen">
      <div className='grid grid-rows-2 grid-cols-3 gap-x-24 gap-y-12 p-20 pt-2 w-140 h-140'>
        <div className="flex flex-col justify-center items-center">
          <Link href="/quiz-list" className="w-52 h-52 bg-pointColor1 rounded-full flex items-center justify-center cursor-pointer">
            <p className="text-white text-2xl font-bold">퀴즈</p>
          </Link>
          <p className="mt-4 text-pointColor1 text-2xl font-bold">퀴즈</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Link href="/community-list" className="w-52 h-52 bg-pointColor1 rounded-full flex items-center justify-center cursor-pointer">
            <p className="text-white text-2xl font-bold">커뮤니티</p>
          </Link>
          <p className="mt-4 text-pointColor1 text-2xl font-bold">커뮤니티</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Link href="/" className="w-52 h-52 bg-pointColor1 rounded-full flex items-center justify-center cursor-pointer">
            <p className="text-white text-2xl font-bold">타자 연습</p>
          </Link>
          <p className="mt-4 text-pointColor1 text-2xl font-bold">타자 연습</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Link href="/mypage" className="w-52 h-52 bg-pointColor1 rounded-full flex items-center justify-center cursor-pointer">
            <p className="text-white text-2xl font-bold">마이 페이지</p>
          </Link>
          <p className="mt-4 text-pointColor1 text-2xl font-bold">마이 페이지</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Link href="/about" className="w-52 h-52 bg-pointColor1 rounded-full flex items-center justify-center cursor-pointer">
