    ...
    <section className="hidden sm:block">
      ...
      >
        <Link href="/" className="flex flex-col items-center gap-2 text-center">
          ...
          <span className={`${isActive('/') ? 'text-pointColor1' : 'text-pointColor3'}`}>홈</span>
        </Link>
        <Link href="/quiz/list" className="flex flex-col items-center gap-2 text-center">
          ...
          <span className={`${isActive('/quiz') ? 'text-pointColor1' : 'text-pointColor3'}`}>퀴즈</span>
        </Link>
        <Link href="/typing-game" className="flex flex-col items-center gap-2 text-center">
          ...
          />
          <span className={`${isActive('/typing-game') ? 'text-pointColor1' : 'text-pointColor3'}`}>타자연습</span>
        </Link>
        <Link href="/phonics" className="flex flex-col items-center gap-2 text-center">
          ...
          <span className={`${isActive('/phonics') ? 'text-pointColor1' : 'text-pointColor3'}`}>한글공부</span>
        </Link>
        <Link href="/community/list/전체" className="flex flex-col items-center gap-2 text-center">
          ...
          />
          <span className={`${isActive('/community') ? 'text-pointColor1' : 'text-pointColor3'}`}>커뮤니티</span>
        </Link>
      </nav>
    </section>
  );
