...
|                                                  발표                                                   |                                               시연 영상                                                |                                             배포 및 README                                              |                                             파일 구조 정리                                              |                                               성능 최적화                                               |

<br><br>

# ⚙️ TECH STACKS

<img src="https://github.com/mm-easy/mm-easy/blob/main/public/readme/Untitled.png"  width ="1000"/>
...
[@시연 영상 링크](https://youtu.be/1cIgF0s6jBQ)
...
생각보다 5주라는 시간이 너무 짧았습니다.

마지막주가 되니 시원섭섭한 기분입니다.

그래도 기획했던 추가기능들도 모두 구현했고 마지막까지 모두 즐겁게 최선을 다했다고 생각합니다.

퀴즈 에디터에 drag and drop 기능을 추가한다면 더욱 에디터다운 에디터가 될 것 같습니다.
...
기획 단계에서는 막막한 부분이 많았는데, 팀원들의 협력 덕분에 기능들을 잘 완성할 수 있어 기쁩니다. 
	
그러나 유저 피드백을 받으면서 생각지도 못한 불편한 점이나 부족한 기능들이 많다는 것을 깨달았습니다.

사용자들이 편안하고 자연스러운 경험을 할 수 있는 사이트를 만들기 위해 계속 노력해야겠습니다.
...
유저 피드백에서 대댓글과 쪽지 기능에 피드백을 받았는데 저걸 왜 생각을 못 했을까 하고 저 자신에 대해 부족함을 느꼈습니다.

그런 부족함이 있었음에도 팀원분들이 훌륭했기에 여기까지 올 수 있었습니다.
...
처음 목표했던 기능들을 거의 다 구현해서 크게 아쉽지 않지만,

그래도 좀 더 다양한 소셜 로그인을 넣지 못했다는 점과 프로필에 있는 레벨 요소를 좀 더 다양한 곳에서 활용하지 못한 것이 조금 아쉬웠습니다.

항상 열심히 노력해주신 팀원분들 덕분에 그런 아쉬움보다는 만족감이 더 컸던 것 같습니다. 다들 수고하셨습니다!
...
사용자의 입장에서는 정말 사소한 부분들도 불편하게 느낄 수 있고 개발자는 이를 고려하여 사용자에게 제공해야 한다는 것을 실제 피드백을 받아보며 알 수 있었습니다. 
	
전부를 반영하고 수정하지 못해서 아쉬움이 남지만, 발전시킬 수 있는 가능성이 많다고 생각하며 좋은 팀원들과 함께 더 개선해 나가겠습니다. 
